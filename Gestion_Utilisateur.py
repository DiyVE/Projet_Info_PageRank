...
class Utilisateur():
    ...
    def recuperer_parametres_utilisateur(self, ligne_commande):
        ...
        try:
            self.parametres["nom_fichier_reseau"] = ligne_commande.pop()  # On lit et on enlève le dernier élément de la liste ligne_commande qui correspond au nom du fichier réseau
        except IndexError:
